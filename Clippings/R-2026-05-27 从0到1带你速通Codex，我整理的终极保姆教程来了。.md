...
created: 2026-05-27
description: "最近Codex的热度，真的感觉直线飙升。社群里一直有人问，什么时候出新的教程。我其实在二月份的时候，写过一篇https://x.com/Khazix0918/status/2020716502903906478?s=20但说实话，那时候的Codex热度很低，而且几个月过去，那时候..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HJS67_mboAANpMC?format=jpg&name=large)

最近Codex的热度，真的感觉直线飙升。

社群里一直有人问，什么时候出新的教程。

我其实在二月份的时候，写过一篇[https://x.com/Khazix0918/status/2020716502903906478?s=20](https://x.com/Khazix0918/status/2020716502903906478?s=20)
...
![Image](https://pbs.twimg.com/media/HJS0z2kaQAAU-VP?format=jpg&name=large)
...
链接在此：[https://chatgpt.com/zh-Hans-CN/codex/](https://chatgpt.com/zh-Hans-CN/codex/)
...
![Image](https://pbs.twimg.com/media/HJS091_awAA92-9?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HJS1G02bkAAYIYV?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HJS1QH5bUAArPWN?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HJS1TzEaUAA772s?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HJS1aXbb0AAmDFx?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HJS1d6oaMAA5mLI?format=png&name=large)

然后，你就进入到了一个具体的项目里，也能看到对话框有变化了。

然后在对话框左下角有三档权限选择。

![Image](https://pbs.twimg.com/media/HJS1hdQawAAxgkY?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HJS1lBLbkAA3Xt7?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HJS11hPaEAATzW2?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HJS2A_daMAApWN9?format=jpg&name=large)

如果在刚才开头那一步忘了导入Claude Code的内容，也没关系，在下面的导入的智能体设置这里，也可以补导入。
...
![Image](https://pbs.twimg.com/media/HJS3UI1bcAAdhyO?format=jpg&name=large)

然后顶部就有tab可以切换插件和技能。

技能这个东西，就是Skills，字面意思，给Agent用的技能。

我相信大家对这个东西已经非常了解了，但是如果你确实还不知道的话，可以去看我之前写的那篇[https://x.com/Khazix0918/status/2010940910083940382?s=20](https://x.com/Khazix0918/status/2010940910083940382?s=20)
...
![Image](https://pbs.twimg.com/media/HJS3kJ9agAA72oY?format=jpg&name=large)

同时也自带了Skill创建器和插件创建器，你想做个啥，都可以直接右上角点创建。

![Image](https://pbs.twimg.com/media/HJS3nESagAAxQOP?format=png&name=large)

然后大白话告诉他你要做什么样的技能和插件就行。

![Image](https://pbs.twimg.com/media/HJS3qDGaEAAT1nn?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HJS4CzeaEAAKdIm?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HJS4QpFaYAA9G2W?format=jpg&name=large)

右上角有几个按钮。

第一个是截图，点一下就能截取当前页面，效果就像下面这样。

![Image](https://pbs.twimg.com/media/HJS4WlwbUAA-Ozs?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HJS4iNZb0AAkKVo?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HJS6EQLaoAAOBxf?format=jpg&name=large)

你其实也不用管什么事Xcode，我觉得绝大多数人电脑上大概率也没有提前安装Xcode，所以呢，你就可以用一个Codex的很屌的邪修方法，直接[@Computer](https://x.com/@Computer) Use，让他来帮我搜索、下载和安装。
...
![Image](https://pbs.twimg.com/media/HJS6IrmaAAAm_a8?format=jpg&name=large)

另一个常用的就是Codex for Chrome，想要使用同样需要开启开关。

这个能沿用你Chrome里已经登录的账号状态，操控浏览器。

![Image](https://pbs.twimg.com/media/HJS6OR9aUAAXuP3?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HJS6YiCaMAA8TC9?format=png&name=large)

里面的雏形也做好了。

![Image](https://pbs.twimg.com/media/HJS6bP-awAAaqBD?format=jpg&name=large)
...
这是前两天刚上线的新功能，我还专门写过一篇文章。[https://x.com/Khazix0918/status/2055144905375359477?s=20](https://x.com/Khazix0918/status/2055144905375359477?s=20)
...
![Image](https://pbs.twimg.com/media/HJS5zSpaMAA3WYM?format=png&name=large)
...
Goal Mode，给Codex定一个目标，它就会自己持续跑下去，直到完成。
